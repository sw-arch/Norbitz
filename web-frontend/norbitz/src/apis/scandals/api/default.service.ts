...
export class DefaultService {
     ...
     * @param dateBefore search for activities before the given timestamp
     * @param dateAfter search for activities after the given timestamp
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public activityGet(name?: string, description?: string, cost?: number, location?: string, dateBefore?: string, dateAfter?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Activity>>;
    public activityGet(name?: string, description?: string, cost?: number, location?: string, dateBefore?: string, dateAfter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Activity>>>;
    public activityGet(name?: string, description?: string, cost?: number, location?: string, dateBefore?: string, dateAfter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Activity>>>;
    public activityGet(name?: string, description?: string, cost?: number, location?: string, dateBefore?: string, dateAfter?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (dateBefore !== undefined) {
            queryParameters = queryParameters.set('dateBefore', <any>dateBefore);
        }
        if (dateAfter !== undefined) {
            queryParameters = queryParameters.set('dateAfter', <any>dateAfter);
        }
