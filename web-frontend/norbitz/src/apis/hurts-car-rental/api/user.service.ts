...
export class UserService {
     ...
     */
    public getMoney(observe?: 'body', reportProgress?: boolean): Observable<Array<Revenue>>;
    public getMoney(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Revenue>>>;
    public getMoney(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Revenue>>>;
    public getMoney(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Revenue>>(`${this.basePath}/money`,
            {
