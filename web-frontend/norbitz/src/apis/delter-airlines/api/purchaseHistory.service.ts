...
export class PurchaseHistoryService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public ticketIDNewName(ticketID: number, newName: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public ticketIDNewName(ticketID: number, newName: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public ticketIDNewName(ticketID: number, newName: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public ticketIDNewName(ticketID: number, newName: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (ticketID === null || ticketID === undefined) {
            throw new Error('Required parameter ticketID was null or undefined when calling ticketIDNewName.');
        }
        ...
        return this.httpClient.put<any>(`${this.basePath}/purchases/ticketID=${encodeURIComponent(String(ticketID))}&name=${encodeURIComponent(String(newName))}`,
            null,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
