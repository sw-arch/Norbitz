...
export class AdminsService {
    ...
    protected basePath = 'https://virtserver.swaggerhub.com/AirDND/AirDND/1.0.2';
     ...
     */
    public addListing(listing: Listing, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public addListing(listing: Listing, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public addListing(listing: Listing, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public addListing(listing: Listing, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (listing === null || listing === undefined) {
            throw new Error('Required parameter listing was null or undefined when calling addListing.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public addReservation(listingID: string, reservation: Reservation, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public addReservation(listingID: string, reservation: Reservation, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public addReservation(listingID: string, reservation: Reservation, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public addReservation(listingID: string, reservation: Reservation, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (listingID === null || listingID === undefined) {
            throw new Error('Required parameter listingID was null or undefined when calling addReservation.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeListing(listingId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public removeListing(listingId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public removeListing(listingId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public removeListing(listingId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (listingId === null || listingId === undefined) {
            throw new Error('Required parameter listingId was null or undefined when calling removeListing.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateListing(listingId: string, listing: Listing, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateListing(listingId: string, listing: Listing, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateListing(listingId: string, listing: Listing, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateListing(listingId: string, listing: Listing, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (listingId === null || listingId === undefined) {
            throw new Error('Required parameter listingId was null or undefined when calling updateListing.');
        }
        if (listing === null || listing === undefined) {
            throw new Error('Required parameter listing was null or undefined when calling updateListing.');
        }
